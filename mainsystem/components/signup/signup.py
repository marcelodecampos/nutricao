...
from mainsystem.components.signup.state import SignupFormState
...
def identification_input() -> rx.Component:
    ...
    return rx.vstack(
        ...
        rx.input(
            ...
            width="100%",
            required=True,
            on_change=SignupFormState.set_cpf,
            on_blur=SignupFormState.on_blur_cpf,
        ),
        spacing="1",
        justify="start",
        width="100%",
...
def email_input() -> rx.Component:
    ...
    return rx.vstack(
        ...
        rx.input(
            ...
            on_blur=SignupFormState.on_blur_email,
        ),
        spacing="1",
        justify="start",
        width="100%",
