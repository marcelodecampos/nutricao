...
"""Inicial Revision. Baseline

Revision ID: 68879994ba42
Revises:
Create Date: 2025-06-02 03:00:30.353221-03:00
...
def downgrade() -> None:
    ...
    op.drop_table("role", schema="access")
    op.drop_table("resource", schema="access")
    op.drop_table("permission", schema="access")
    # ### end Alembic commands ###
